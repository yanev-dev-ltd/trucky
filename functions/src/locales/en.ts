export const en = {
  ...
  "documentReminderDescription": "Document Reminder for {document}",
  "documentTimeReminder": "Document Time Reminder",
  ...
  "maintenanceTrailerDateDescription": "The maintenance for trailer {trailer} has reached its date notification.",
  "questions": "Questions?",
  "trailer": "Trailer",
  "trucky": "Trucky EOOD",
  "vehicle": "Vehicle",
